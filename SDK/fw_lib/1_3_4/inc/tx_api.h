...
/* FX3 specific functions for OS level debugging and profiling. */
...
UINT        tx_semaphore_set_profile_gpio(TX_SEMAPHORE *semaphore_ptr, ULONG gpio_id);
UINT        tx_event_flags_set_profile_gpio(TX_EVENT_FLAGS_GROUP *group_ptr, ULONG gpio_id);
