...
#define PRINT_VGA_REG		1
#define PRINT_INITIAL_REGISTERS		0
#define PRINT_ACTUAL_VCO_AND_ERR	1
...
static int r82xx_set_pll(struct r82xx_priv *priv, uint32_t freq)
{
...
#if PRINT_ACTUAL_VCO_AND_ERR
	{
	  ...
	  fprintf(stderr, "[R82XX] requested %u Hz; selected mix_div=%u vco_freq=%I64u nint=%u sdm=%u; actual_vco=%I64u; tuning error=%+dHz\n",
