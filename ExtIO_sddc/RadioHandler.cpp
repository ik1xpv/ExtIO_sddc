	...
	firmware(0)
{
	...
	// Allocate finetune
	stateFineTune = (shift_limited_unroll_C_sse_data_t*) malloc(sizeof(shift_limited_unroll_C_sse_data_t));
	*stateFineTune = shift_limited_unroll_C_sse_init(0.0F, 0.0F);
}
...
void RadioHandlerClass::UpdFine_LO(bool flag)
{
	fine_LO = flag;
}
